...
function PublicStatsBand({ items }: PublicStatsBandProps) {
  return (
    <div className="grid rounded-3xl border border-primary/25 bg-white/45 p-6 shadow-[0_18px_45px_rgba(31,25,76,0.04)] sm:grid-cols-2 lg:grid-cols-4">
      {items.map((item) => (
